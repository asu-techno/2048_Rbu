...
namespace _2048_Rbu.Elements.Mechs
{
    ...
    /// </summary>
    public partial class ElMixer : INotifyPropertyChanged, IElementsUpdater
    {
        ...
        public Position ModePos
        {
            ...
            set
            {
                ...
                if (value == Position.Down)
                    lbl_mode.Margin = new Thickness(-2, 12, 0, 0);
        ...
        public Position NamePos
        {
            ...
            set
            {
                if (value == Position.LeftUp)
                {
                    tbc_name.Margin = new Thickness(0, 4, 62, 0);
                ...
                if (value == Position.RightUp)
                {
                    tbc_name.Margin = new Thickness(62, 4, 0, 0);
