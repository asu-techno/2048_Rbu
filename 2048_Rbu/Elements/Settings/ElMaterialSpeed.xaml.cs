...
namespace _2048_Rbu.Elements.Settings
{
    ...
    public partial class ElMaterialSpeed : INotifyPropertyChanged
    {
        ...
        public void Initialize(OpcServer.OpcList opcName)
        {
            ...
            _settings[5].Initialize(_opcName, Static.СontainerNameDictionary[Static.ContainerItem.Additive1] + " (" + Static.СontainerMaterialDictionary[Static.ContainerItem.Additive1] + "). добавка №1. Предельная скорость дозирования, кг/с", 0, 100.0, "Additive.Load_Tank1", WindowSetParameter.ValueType.Real, 1, 0.5, 5.0, 10.0, 50.0, 1.0);
            ...
            _settings[7].Initialize(_opcName, "Химическая добавка. Предельная скорость сброса, кг/с", 0, 100.0, "Additive.Unload", WindowSetParameter.ValueType.Real, 1, 0.5, 5.0, 10.0, 50.0, 1.0);
            _settings[8].Initialize(_opcName, Static.СontainerNameDictionary[Static.ContainerItem.Bunker1] + " (" + Static.СontainerMaterialDictionary[Static.ContainerItem.Bunker1] + "). добавка №1. Предельная скорость дозирования, кг/с", 0, 100.0, "Inert.Load_Bunker1", WindowSetParameter.ValueType.Real, 1, 0.5, 5.0, 10.0, 50.0, 1.0);
            _settings[9].Initialize(_opcName, Static.СontainerNameDictionary[Static.ContainerItem.Bunker2] + " (" + Static.СontainerMaterialDictionary[Static.ContainerItem.Bunker2] + "). добавка №2. Предельная скорость дозирования, кг/с", 0, 100.0, "Inert.Load_Bunker2", WindowSetParameter.ValueType.Real, 1, 0.5, 5.0, 10.0, 50.0, 1.0);
            _settings[10].Initialize(_opcName, Static.СontainerNameDictionary[Static.ContainerItem.Bunker3] + " (" + Static.СontainerMaterialDictionary[Static.ContainerItem.Bunker3] + "). добавка №2. Предельная скорость дозирования, кг/с", 0, 100.0, "Inert.Load_Bunker3", WindowSetParameter.ValueType.Real, 1, 0.5, 5.0, 10.0, 50.0, 1.0);
